...
<form id="form-recovery-form" action="" data-component="validate" method="post" class="form form-centered"><input type="hidden" name="authorize-token" value="">
    ...
    <div class="form-item">
        <label>Su dirección de correo electrónico <span class="error" id="user-email-validation-error"></span></label>
    ...
    <p>
        <button class="button primary width-100">Enviar</button>
    </p>

    <p><a href="/account/" class="small muted">Volver a identificarme</a></p>
</form>
